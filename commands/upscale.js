...
module.exports = {
	...
	execute: async function(msg, context, data, channel) {
		...
		const payload = {
			...
			"script_args": [0,    512,        0,            16,         32,       64,               0.35,               32,                 5,              true,                 0,            false,                 16,                   0,              2,    			  2048,         2048,          2]
			//              '_',  tile_width, tile_height,  mask_blur,  padding,  seams_fix_width,  seams_fix_denoise,  seams_fix_padding,  upscaler_index, save_upscaled_image,  redraw_mode,  save_seams_fix_image, seams_fix_mask_blur,  seams_fix_type, target_size_type, custom_width, custom_height, custom_scale
		}
